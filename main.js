...
randomN = Math.floor((Math.random()*quick_draw_data_set.length)+1)
object = quick_draw_data_set[randomN]

document.getElementById('sketch_name').innerHTML = 'Sketch to be drawn: ' + object;
time_counter = 0 
time_check = ''
draw_sketch = ''
answer_hold = ''
